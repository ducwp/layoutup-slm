<?php
/*
Plugin Name: LayoutUP SLM
Version: 4.4.8
Plugin URI: https://github.com/ducwp/layoutup-slm
Author: Duc Nguyen & Tips and Tricks HQ
...
define('WP_LICENSE_MANAGER_VERSION', "4.4.8");
define('WP_LICENSE_MANAGER_DB_VERSION', '1.5');
